...
{
        //Find a patient
        public static string FindPatient(string name, List<Client> item)
        {
        ...
        // Create new patient
        public static void CreatePatient(List<Client> item)
        {
            try
            {
                ...
                item.Add(new Client(name, age, symptoms));
        ...
        //Read the list
        public static void ShowList(List<Client> item)
        {
